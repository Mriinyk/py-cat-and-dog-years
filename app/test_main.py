...
def test_check_age(cat_age: int, dog_age: int,
              human_age: list) -> None:
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(10000, 4, ValueError, id=" data is to large"),
        pytest.param(1, 20000, ValueError, id=" data is to large"),
...
def test_check_expected_errors(cat_age: int, dog_age: int,
